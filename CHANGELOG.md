...
- Clarify that missing inventory targets remain unverified in outgoing-reference
  details and Anatomy. Preserve ambiguity wording, navigation, graph connectivity,
  counts, and comparison/trend payloads.
